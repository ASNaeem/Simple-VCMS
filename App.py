...
## Animal ##
    ...
    def add_animal_to_table(self, row, animal):
        ...
        self.page_animal_info.table_animal.setItem(row, 5, QTableWidgetItem(animal.species))
        self.page_animal_info.table_animal.setItem(row, 6, QTableWidgetItem(animal.breed))
        self.page_animal_info.table_animal.setItem(row, 7, QTableWidgetItem(animal.color))
        self.page_animal_info.table_animal.setItem(row, 8, QTableWidgetItem(animal.behavioral_warning))
        self.page_animal_info.table_animal.setItem(row, 9, QTableWidgetItem(animal.owner_name))
        self.page_animal_info.table_animal.setItem(row, 10, QTableWidgetItem(animal.email))
        self.page_animal_info.table_animal.setItem(row, 11, QTableWidgetItem(animal.phone))
