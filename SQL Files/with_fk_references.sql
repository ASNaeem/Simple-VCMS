...
insert into animals (animal_name, birth_date, sterilized, gender, species, breed, color, behavioral_warning, 
					owner_name, email, phone, address, reg_date, med_condition) 
values ('Fox', 'grey','2022-11-23','yes','female','dog','husky','white','none',
         'Alvis','awitheridge0@about.com','+789-553-4487','1 Blaine Trail','2023-11-28','unhealthy');
insert into animals (animal_name, birth_date, sterilized, gender, species, breed, color, behavioral_warning, 
					owner_name, email, phone, address, reg_date, med_condition) 
values ('Colobus','black and white','2022-12-3','yes','male','Dog','Husky','White','none',
        'Idalia','iroutledge1@chicagotribune.com','+886-582-2049','0 Logan Park','2023-10-30','healthy');
insert into animals (animal_name, birth_date, sterilized, gender, species, breed, color, behavioral_warning, 
					owner_name, email, phone, address, reg_date, med_condition) 
values ('chic', 'emerald-spotted wood','2023-12-2','no','male','Chicken','Pakistani','black','none',
...
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (1, '2022-01-21', '15:00', 'Neuter', 'scheduled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (2, '2021-05-30', '10:00', 'Regular Checkup', 'completed');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (3, '2022-12-11', '15:00', 'Rabies Vaccine', 'cancelled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (4, '2020-04-11', '12:00', 'C-Section', 'cancelled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (5, '2020-10-12', '11:00', 'Rabies Vaccine', 'completed');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (6, '2021-07-26', '14:00', 'Wound Dressing', 'completed');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (7, '2020-12-10', '10:00', 'Spay', 'cancelled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (8, '2020-04-28', '15:00', 'Flu Vaccine', 'cancelled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (9, '2021-04-30', '15:00', 'Rabies Vaccine', 'completed');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (10, '2022-05-25', '14:00', 'Regular Checkup', 'completed');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (1, '2023-09-23', '11:23',' c- section', 'scheduled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (2,'2023-02-28','14:45','neuter','scheduled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (3,'2023-10-10','16:56','dental care','scheduled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (1, '2023-06-17',' 15:52' , 'c- section',' completed');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (5, '2023-03-26',' 18:26','vaccination','scheduled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (6,'2023-09-27','19:12','vaccination','cancelled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (6,'2023-09-27','19:12','vaccination','cancelled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (8,'2023-02-23','16:29','c- section','scheduled');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (9,'2023-05-08','10:05','c- section','completed');
insert into appointments (animal_id, a_date, a_time, visit_reason, a_status) values (10, '2023-05-25', '14:00', 'Regular Checkup', 'completed');
...
CREATE TRIGGER insert_into_bill
...
insert into employees (name, email, password, address, designation, access_level, working_hours, salary, joining_date, employee_status) values ('Sibilla Boswood','sboswood0@unc.edu','$2a$04$szEu0FH73vS8N677z0f7KuzG.pdxAHBQmX7UVS4L6TSaneK2TRqrG','0515 Harper Place','Manager',4,'10:35',15507,'2023-06-02','Working');
insert into employees (name, email, password, address, designation, access_level, working_hours, salary, joining_date, employee_status) values ('Desdemona Lillee','dlillee1@drupal.org','$2a$04$Q4yadFcxY62VZ754USnJB','2 Algoma Terrace','general employee',3,'7:38',13981,'2023-07-18','on leave');
insert into employees (name, email, password, address, designation, access_level, working_hours, salary, joining_date, employee_status) values ('Carmencita Yoxall','cyoxall2@pagesperso-orange.fr','$2a$04$04cF','1 Sloan Crossing','recieptionsist',2,'8am -9pm',5417,'2023-08-15','on leave');
insert into employees (name, email, password, address, designation, access_level, working_hours, salary, joining_date, employee_status) values ('Alysa Broker','abroker3@hud.gov','$2a$04$qwmVdbHh/o7Ly','33 Holmberg Junction','vet',1,'9am - 10pm',12448,'2023-04-26','Working');
insert into employees (name, email, password, address, designation, access_level, working_hours, salary, joining_date, employee_status) values ('Gertrud Netherwood','gnetherwood4@bloglines.com','.66NwXoYqieESQ1KXMQjnR3KX5Uo4GOa','476 Birchwood Point','Manager',4,'9am - 10pm',19730,'2023-05-10','on leave');
insert into employees (name, email, password, address, designation, access_level, working_hours, salary, joining_date, employee_status) values ('Sisely Ramsay','sramsay5@sohu.com','rgZmk5pG2OsXd','77176 Badeau Trail','general employee',3,'9am - 5pm',858,'2023-04-18','on leave');
insert into employees (name, email, password, address, designation, access_level, working_hours, salary, joining_date, employee_status) values ('Mellie Crunkhurn','mcrunkhurn6@pen.io','HSCa9k8An0e6Mc','3 Bay Hill','recieptionsist',2,9am - 10pm,29503,'2023-07-06','on leave');
insert into employees (name, email, password, address, designation, access_level, working_hours, salary, joining_date, employee_status) values ('Athena Mitskevich','amitskevich7@seesaa.net', '2a$04','3073 Macpherson Alley','vet',1,'10am 8pm',20237,'2023-07-11','Working');
insert into employees (name, email, password, address, designation, access_level, working_hours, salary, joining_date, employee_status) values ('Ollie Flye','oflye8@twitpic.com','2ahjj','1647 Bowman Alley','Manager',4, '9am -10',16433,'2023-10-21','Working');
...
insert into expenses ( issuer_id, expense_date, handle_date, amount, justification) values ( 10, '2022-01-24', 9453.71, 'New lights was bought for the clinic');
insert into expenses ( issuer_id, expense_date, handle_date, amount, justification) values ( 9, '2022-12-23', 9456.01, 'An order for a rare medicine was placed with an advanced payment.');
insert into expenses ( issuer_id, expense_date, handle_date, amount, justification) values ( 8, '2023-02-27', 7579.5, 'reason for the expense was to repair the x-ray machine');
insert into expenses ( issuer_id, expense_date, handle_date, amount, justification) values ( 7,'2023-03-16',  4426.23, 'Surgery equipment was changed');
insert into expenses ( issuer_id, expense_date, handle_date, amount, justification) values ( 6,'2023-04-26', 4651.62, 'Air conditioner servicing was done this was the cost');
insert into expenses ( issuer_id, expense_date, handle_date, amount, justification) values ( 5,'2023-05-23', 2052.58, 'Toiletries was bought');
insert into expenses ( issuer_id, expense_date, handle_date, amount, justification) values ( 4,'2023-05-29', 9274.36, 'reason for the expense was to repair the x-ray machine');
insert into expenses ( issuer_id, expense_date, handle_date, amount, justification) values ( 3,'2023-06-23', 2016.62, 'updated the emergency medicine stock so this was the cost');
insert into expenses ( issuer_id, expense_date, handle_date, amount, justification) values ( 2, '2023-07-13', 2820.38, 'Toiletries was bought');
insert into expenses ( issuer_id, expense_date, handle_date, amount, justification) values ( 1, '2023-07-23', 9700.27, 'New lights was bought for the clinic');
...
insert into phones (employee_id, phone)values (11, '+880-155-240-7452');
insert into phones (employee_id, phone)values (11, '+880-155-545-8888');
insert into phones (employee_id, phone)values (12, '+880-155-550-7452');
insert into phones (employee_id, phone)values (12, '+880-155-555-8888');
insert into phones (employee_id, phone)values (13, '+880-115-553-3834');
insert into phones (employee_id, phone)values (13, '+880-195-550-0422');
insert into phones (employee_id, phone)values (14, '+880-115-552-7181');
insert into phones (employee_id, phone)values (14, '+880-115-559-7397');
insert into phones (employee_id, phone)values (15, '+880-185-558-5645');
insert into phones (employee_id, phone)values (15, '+880-185-554-2563');
insert into phones (employee_id, phone)values (16, '+880-115-553-3505');
insert into phones (employee_id, phone)values (16, '+880-185-559-1210');
insert into phones (employee_id, phone)values (17, '+880-155-551-2280');
insert into phones (employee_id, phone)values (17, '+880-175-558-9049');
insert into phones (employee_id, phone)values (18, '+880-185-554-1326');
insert into phones (employee_id, phone)values (18, '+880-185-556-9427');
insert into phones (employee_id, phone)values (19, '+880-115-553-3523');
insert into phones (employee_id, phone)values (19, '+880-165-552-4421');
...
insert into record (animal_id, record, rdate) values (10, 'a history of chronic urinary tract infections for the past 3 years.', '2022-12-23');
insert into record (animal_id, record, rdate) values (10, 'Got bit by a cat in the leg.', '2023-01-31');
insert into record (animal_id, record, rdate) values (13, 'Got into fight with another cat, got bitten by a cat on front leg.', '2023-09-13');
insert into record (animal_id, record, rdate) values (13, 'Twisted left back leg, having trouble walking.', '2022-12-08');
insert into record (animal_id, record, rdate) values (14, 'Had a fight.', '2023-10-15');
insert into record (animal_id, record, rdate) values (5, 'Feathers are falling of off the skin for some unknown  reason.', '2023-10-18');
insert into record (animal_id, record, rdate) values (16, 'experienced lethargy and decreased appetite for two days.', '2022-03-10');
insert into record (animal_id, record, rdate) values (17, 'a history of vomiting and diarrhea for the past 24 hours', '2022-02-03');
insert into record (animal_id, record, rdate) values (18, 'a history of excessive urination and water consumption for the past 2 weeks.', '2023-08-24');
insert into record (animal_id, record, rdate) values (19, 'a history of seizures for the past 6 months.', '2023-06-09');
...
create table veterinarians (
            ...
            constraint fk_employee_id_vet foreign key(employee_id) references employees (employee_id)) on delete cascade;
...
insert into bill_services (bid, service_id) values (3,10);
