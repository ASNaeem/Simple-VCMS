...
insert into employees (name, email, password, address, designation, access_level, salary, joining_date, employee_status) values ('Marie-jeanne MacGinney', 'mmacginney0@goo.gl', 'pE9"''*''E', '49517 Mayfield Parkway', 'Manager', 2, 32568.01, '2022-09-23', 'Working');
insert into employees (name, email, password, address, designation, access_level, salary, joining_date, employee_status) values ('Korey MacCaull', 'kmaccaull1@multiply.com', 'lU6{)3gfw', '25 Hoard Terrace', 'Manager', 3, 45196.66, '2022-06-04', 'Working');
insert into employees (name, email, password, address, designation, access_level, salary, joining_date, employee_status) values ('Avivah Barnard', 'abarnard2@mayoclinic.com', 'lF7*b!yxT#Vy8s', '766 Schmedeman Terrace', 'Manager', 3, 27244.32, '2022-05-08', 'Working');
insert into employees (name, email, password, address, designation, access_level, salary, joining_date, employee_status) values ('Fred Nelsen', 'fnelsen3@ed.gov', 'zI9>ZBaM}{NWN', '44 Becker Court', 'Manager', 2, 18299.92, '2022-11-20', 'Working');
insert into employees (name, email, password, address, designation, access_level, salary, joining_date, employee_status) values ('Lola Rossetti', 'lrossetti4@howstuffworks.com', 'xB1}}S?Z', '32 Tony Alley', 'General Staff', 3, 32075.0, '2022-07-13', 'Working');
insert into employees (name, email, password, address, designation, access_level, salary, joining_date, employee_status) values ('Maryl Skacel', 'mskacel5@alibaba.com', 'sS1!+ZWYl_l''s"n', '8 Pleasure Plaza', 'Receptionist', 3, 14217.02, '2022-11-19', 'Working');
insert into employees (name, email, password, address, designation, access_level, salary, joining_date, employee_status) values ('Ethelbert Huckstepp', 'ehuckstepp6@myspace.com', 'kT9~ONq{(L4', '22385 Duke Terrace', 'Veterinarian', 2, 14082.95, '2022-06-22', 'On leave');
insert into employees (name, email, password, address, designation, access_level, salary, joining_date, employee_status) values ('Shayne Laydel', 'slaydel7@tinypic.com', 'yG7-~@<>cAoPYD68', '46453 Lukken Road', 'Manager', 1, 35247.04, '2022-04-23', 'Working');
...
insert into expenses (handler_id, issuer_id, expense_date, handle_date, amount, justification) values (1, 10, '2022-01-24', '2022-01-23', 9453.71, 'New lights was bought for the clinic');
insert into expenses (handler_id, issuer_id, expense_date, handle_date, amount, justification) values (2, 9, '2022-12-23', '2022-12-22', 9456.01, 'An order for a rare medicine was placed with an advanced payment.');
insert into expenses (handler_id, issuer_id, expense_date, handle_date, amount, justification) values (3, 8, '2023-02-27', '2023-02-26', 7579.5, 'reason for the expense was to repair the x-ray machine');
insert into expenses (handler_id, issuer_id, expense_date, handle_date, amount, justification) values (4, 7,'2023-03-16', '2023-03-15', 4426.23, 'Surgery equipment was changed');
insert into expenses (handler_id, issuer_id, expense_date, handle_date, amount, justification) values (5, 6,'2023-04-26', '2023-04-25', 4651.62, 'Air conditioner servicing was done this was the cost');
insert into expenses (handler_id, issuer_id, expense_date, handle_date, amount, justification) values (6, 5,'2023-05-23', '2023-05-22', 2052.58, 'Toiletries was bought');
insert into expenses (handler_id, issuer_id, expense_date, handle_date, amount, justification) values (7, 4,'2023-05-29', '2023-05-28', 9274.36, 'reason for the expense was to repair the x-ray machine');
insert into expenses (handler_id, issuer_id, expense_date, handle_date, amount, justification) values (8, 3,'2023-06-23', '2023-06-25', 2016.62, 'updated the emergency medicine stock so this was the cost');
insert into expenses (handler_id, issuer_id, expense_date, handle_date, amount, justification) values (9, 2, '2023-07-13', '2023-07-14', 2820.38, 'Toiletries was bought');
insert into expenses (handler_id, issuer_id, expense_date, handle_date, amount, justification) values (10, 1, '2023-07-23', '2023-07-24', 9700.27, 'New lights was bought for the clinic');
...
insert into phones (employee_id, phone)values (1, '+880-155-240-7452');
insert into phones (employee_id, phone)values (1, '+880-155-545-8888');
insert into phones (employee_id, phone)values (2, '+880-155-550-7451');
insert into phones (employee_id, phone)values (2, '+880-155-555-8887');
insert into phones (employee_id, phone)values (3, '+880-115-553-3834');
insert into phones (employee_id, phone)values (3, '+880-195-550-0422');
insert into phones (employee_id, phone)values (4, '+880-115-552-7181');
insert into phones (employee_id, phone)values (4, '+880-115-559-7397');
