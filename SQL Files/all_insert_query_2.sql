...
insert into billings ( day_care_id, aid, payment_date, total_amount, adjustment, status) values (1, 4, "2022-01-21", 1500.00, 300.00, "Due");
insert into billings ( day_care_id, aid, payment_date, total_amount, adjustment, status) values (null, 2, "2021-05-30", 1000.00, 550.00, "Paid");
...
insert into billings ( day_care_id, aid, payment_date, total_amount, adjustment, status) values (5, 6, "2020-10-12", 1000.00, 100.00,"Paid");
...
insert into billings ( day_care_id, aid, payment_date, total_amount, adjustment, status) values (2, 7, "2021-05-30", 1000.00, 550.00, "Paid");
insert into billings ( day_care_id, aid, payment_date, total_amount, adjustment, status) values (null, 3, "2022-12-11", 1800.00, 280.00, "Due");
insert into billings ( day_care_id, aid, payment_date, total_amount, adjustment, status) values (4, 8, "2020-04-11", 1500.00, 650.00,"Paid");
insert into billings ( day_care_id, aid, payment_date, total_amount, adjustment, status) values (null, 5, "2020-10-12", 1000.00, 100.00,"Paid");
/* day_care*/
...
/* employee */
create table employees (employee_id int auto_increment primary key, name varchar(45), email varchar(100), password varchar(50), address varchar(100), designation varchar(50), access_level int, salary decimal(10,2), joining_date date, employee_status varchar(10));
...
/* expenses */
expenses (expense_id int  auto_increment primary key,
		issuer_id int,               
		expense_date date,
		amount decimal(10,2),
