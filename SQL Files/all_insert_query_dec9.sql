...
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (2,7, '2021-05-30', '10:00', 'Regular Checkup', 'completed');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (3,17, '2022-12-11', '15:00', 'Rabies Vaccine', 'cancelled');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (4,17, '2020-04-11', '12:00', 'C-Section', 'cancelled');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (5,7, '2020-10-12', '11:00', 'Rabies Vaccine', 'completed');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (6,19, '2021-07-26', '14:00', 'Wound Dressing', 'completed');
...
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (8,19, '2020-04-28', '15:00', 'Flu Vaccine', 'cancelled');
...
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (10,7, '2022-05-25', '14:00', 'Regular Checkup', 'completed');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (1,19, '2023-09-23', '11:23',' c- section', 'scheduled');
...
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (3,7,'2023-10-10','16:56','dental care','scheduled');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (1,17, '2023-06-17',' 15:52' , 'c- section',' completed');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (5,7, '2023-03-26',' 18:26','vaccination','scheduled');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (6,19,'2023-09-27','19:12','vaccination','cancelled');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (6,19,'2023-09-27','19:12','vaccination','cancelled');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (8,17,'2023-02-23','16:29','c- section','scheduled');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (9,7,'2023-05-08','10:05','c- section','completed');
insert into appointments (animal_id, employee_id, a_date, a_time, visit_reason, a_status) values (10,9, '2023-05-25', '14:00', 'Regular Checkup', 'completed');
